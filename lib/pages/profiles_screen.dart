...
class _ProfilesScreenState extends State<ProfilesScreen>
  ...
  Future<void> _showProfileContextMenu(
    ...
    final result = await AdaptiveContextMenu.show<String>(
      ...
      items: [
        ...
        AdaptiveContextMenuItem(
          label: NekoSimStrings.of(context).addToAssets,
    ...
    if (result == 'nekosim_asset') _addProfileToNekoSimAssets(profile);
  ...
  Future<void> _addProfileToNekoSimAssets(EuiccProfile profile) async {
    try {
      final asset = await NekoSimAssetService().createFromProfile(
        profile,
        eid: _eid,
      );
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(NekoSimStrings.of(context).linkedToAssets(
              asset.operatorName.isEmpty ? profile.iccid : asset.operatorName)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${NekoSimStrings.of(context).linkFailed}: $e'),
