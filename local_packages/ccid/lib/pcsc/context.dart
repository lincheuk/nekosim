...
class Context {
  ...
  /// Returns a list of connected card readers.
  Future<Map<String, String>> listReadersWithAtr() async {
    try {
      return await pcsc.listReadersWithAtr(_hContext);
    } on NoReaderException {
      return {};
    }
  }
  ...
  Future<Card> connect(
    ...
    return Card._internal(
        connection.hCard, connection.activeProtocol, connection.atr);
  }
}
...
class Card {
  ...
  Card._internal(this._hCard, this.activeProtocol, this.atr);
